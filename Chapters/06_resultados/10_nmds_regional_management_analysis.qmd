...
Esta sección presenta un análisis regional comprensivo que combina el NMDS de vegetación de dunas costeras con las prácticas de gestión para cada una de las tres regiones catalanas: Tarragona, Barcelona y Girona. Este enfoque integrado nos permite entender cómo la intensidad de gestión (medida en una escala ordinal de 0-5) afecta los patrones de vegetación dentro de cada región biogeográfica.
...
El gradiente continuo de intensidad de gestión confirma la ausencia de patrones claros en las tres regiones (@fig-regional-management-gradient). La distribución aleatoria de colores (intensidades de gestión) en el espacio de ordenación indica que el gradiente de manejo no estructura las comunidades vegetales de forma consistente. Tarragona y Girona muestran mayor rango de intensidades pero sin segregación espacial evidente, mientras Barcelona mantiene valores uniformemente bajos.

```{r}
#| label: fig-regional-management-gradient
#| fig-cap: "Gradiente continuo de gestión regional mostrando distribución aleatoria de intensidades sin patrones espaciales evidentes en el espacio de ordenación NMDS."
#| echo: false
#| eval: true
#| output: true
#| fig-width: 16
...
La interacción hábitat-gestión muestra patrones regionales distintos (@fig-habitat-management-interaction). Barcelona presenta exclusivamente gestión baja en todos los hábitats, confirmando su homogeneidad. Tarragona distribuye gestión moderada (52-62%) y baja (22-38%) entre hábitats, mientras Girona incluye áreas sin gestión (6-19%) además de gestión baja y moderada, mostrando mayor diversidad de enfoques de manejo por tipo de hábitat.

```{r}
#| label: fig-habitat-management-interaction
#| fig-cap: "Distribución de gestión por hábitat regional, confirmando homogeneidad en Barcelona, distribución equilibrada en Tarragona, y mayor diversidad de enfoques en Girona."
#| echo: false
#| eval: true
#| output: true
#| fig-width: 12
