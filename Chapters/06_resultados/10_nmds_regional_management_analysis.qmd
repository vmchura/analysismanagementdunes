...
#| fig-cap: "Gráficos NMDS mostrando patrones de composición de vegetación superpuestos con categorías de intensidad de gestión para cada región. Los puntos representan parcelas individuales coloreadas por categoría de gestión y con formas según el tipo de hábitat."
#| echo: false
#| eval: true
#| output: true
#| fig-width: 16
