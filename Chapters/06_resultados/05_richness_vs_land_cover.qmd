...
## Riqueza de Especies vs Cobertura del Suelo

Relación entre la riqueza de especies y los tipos de cobertura del suelo a 50m y 100m de las playas.

```{r}
#| label: fig-riqueza-vs-cobertura-suelo
...
ggplot(richness_vs_land, aes(x = percentage, y = richness, color = region)) +
  ...
  theme_minimal() +
  labs(
    title = "Riqueza de Especies vs Tipos de Cobertura del Suelo\na Diferentes Distancias",
...
La @fig-riqueza-vs-cobertura-suelo muestra las relaciones entre riqueza y cobertura del suelo. Se visualiza que en el tipo de cobertura de suelo de Urbano, Bosques, Cultivos y Pastizal, la región de Girona tiene menos diversidad vegetal que la región de Tarragona.
