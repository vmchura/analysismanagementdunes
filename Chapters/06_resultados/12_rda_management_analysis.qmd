...
La @tbl-rda-summary presenta los resultados principales del análisis de redundancia (RDA) aplicado por separado a cada región. La significancia estadística indica que las relaciones observadas entre gestión y vegetación no alcanzan la significancia estadística. El número de variables de gestión seleccionadas mediante forward selection varió entre regiones, sugiriendo diferentes patrones de influencia de las prácticas de manejo.
...
#| fig-cap: "Partición de varianza mediante análisis de redundancia combinado."
#| echo: false
#| eval: true
#| output: true
#| fig-width: 12
...
#| fig-cap: "Plot del análisis de redundancia combinado."
#| echo: false
#| eval: true
#| output: true
#| fig-width: 12
