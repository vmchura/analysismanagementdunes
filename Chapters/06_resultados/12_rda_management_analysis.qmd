...
if(exists("rda_summary") && nrow(rda_summary) > 0) {
  ...
  knitr::kable(rda_summary_display,
    ...
    kableExtra::footnote(general = c("Códigos de significancia: *** p<0.001, ** p<0.01, * p<0.05, . p<0.1, (n.s.) = no significativo",
                                     "NA = No aplicable debido a sobreajuste estadístico (Barcelona: datos insuficientes para test de significancia)"))
} else {
