...
#### Análisis CCA con Variables de Gestión por Región y Especies

Este capítulo presenta el Análisis de Correspondencias Canónicas (CCA) examinando las relaciones entre la composición de vegetación de dunas costeras y las prácticas de gestión de playas en las tres regiones: Girona, Barcelona y Tarragona.
...
#| tbl-cap: "Resumen de efectos de variables de gestión entre regiones, mostrando qué prácticas de gestión son más importantes para la conservación de vegetación."
#| echo: false
#| eval: true
#| output: true
#| tbl-pos: "H"
...
if(length(valid_results) > 0) {
  ...
  if(nrow(mgmt_effects_summary) > 0) {
    ...
    knitr::kable(mgmt_effects_summary,
                 col.names = c("Región", "Variable de Gestión", "Importancia", "Valor P", "Sig."),
