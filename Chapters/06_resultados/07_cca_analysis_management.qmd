...
#| fig-cap: "Biplots CCA regionales mostrando cómo responde la vegetación a las prácticas de gestión en cada región de Cataluña. Cada gráfico revela qué prácticas de gestión son más efectivas para conservar la vegetación de dunas costeras en diferentes contextos regionales."
#| echo: false
#| eval: true
#| output: true
#| fig-width: 15
