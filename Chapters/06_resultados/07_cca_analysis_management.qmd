...
if(!is.null(combined_cca_mgmt)) {
  ...
  # Save the plot
  ggsave(here("figures","cca_combined_management_analysis.png"), p_combined_mgmt, width = 12, height = 10)
} else {
...
if(length(regional_mgmt_plots) > 0) {
  ...
  if(length(valid_mgmt_plots) > 0) {
    ...
    ggsave(here("figures","cca_regional_management_analysis.png"), combined_regional_mgmt,
           width = 14, height = 16)
  } else {
...
c("Region", "Explained Variance (%)", "Species Count", "Beach Count")),
      caption = "CCA Summary: Explained Variance, Species and Beach Counts",
      format = "latex", booktabs = TRUE) %>%
  kable_styling(latex_options = "hold_position")

knitr::kable(setNames(results_summary[, c("Region", "Management_Variables")], c("Region", "Variables descriptivas para CCA")),
      caption = "Management Variables by Region",
      format = "latex", booktabs = TRUE) %>%
  kable_styling(latex_options = "hold_position") %>%
