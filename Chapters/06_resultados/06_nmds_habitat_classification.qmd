...
Esta sección presenta los resultados de un análisis de Escalamiento Multidimensional No Métrico (NMDS) para clasificar las parcelas de vegetación de dunas costeras en tipos de hábitat distintos. El NMDS es una técnica de ordenación poderosa que representa las muestras en un espacio de baja dimensión mientras preserva las distancias ecológicas entre ellas.
