...
#| fig-cap: "Gráfico de ordenación NMDS mostrando la relación entre la composición de vegetación y las prácticas de gestión de playas. Los puntos representan parcelas individuales coloreadas por región y con formas según la categoría de intensidad de gestión."
#| echo: false
#| eval: true
#| output: true
#| fig-width: 12
...
p_nmds_management <- ggplot(nmds_data %>% filter(!is.na(management_simple)), 
  ...
  theme_minimal() +
  labs(
    title = "Ordenación NMDS: Respuesta de la Vegetación a la Intensidad de Gestión",
  ...
  scale_shape_discrete(name = "Intensidad de Gestión") +
  ...
  guides(
    ...
    shape = guide_legend(title = "Intensidad de Gestión"),
...
#| fig-cap: "Distribución de prácticas de gestión en las tres regiones de Cataluña, mostrando la proporción de parcelas bajo diferentes intensidades de gestión dentro de cada región."
#| echo: false
#| eval: true
#| output: true
#| fig-width: 10
...
#| fig-cap: "Comparación de puntuaciones de prácticas de gestión individuales entre regiones, mostrando la intensidad promedio (escala 0-5) de senderos gestionados, vallados con cuerdas, limpieza mecánica e impactos de servicios."
#| echo: false
#| eval: true
#| output: true
#| fig-width: 14
...
#| fig-cap: "Respuesta de la composición de especies a diferentes intensidades de gestión, mostrando cómo varían las comunidades vegetales entre áreas de dunas costeras no gestionadas y altamente gestionadas."
#| echo: false
#| eval: true
#| output: true
#| fig-width: 14
