...
This section presents the results of a Non-metric Multidimensional Scaling (NMDS) analysis to examine how beach management practices influence coastal dune vegetation composition. The analysis combines species data with management variables including managed paths, rope fences, mechanical cleaning, and protection status to understand how different management approaches affect plant community structure.
