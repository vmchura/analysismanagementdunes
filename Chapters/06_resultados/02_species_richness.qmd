...
## Riqueza de Especies por Región

La riqueza de especies se calcula como el número total de especies presentes en cada playa. Este análisis compara la biodiversidad entre las tres regiones costeras catalanas.
...
La @fig-riqueza-especies muestra diferencias en la riqueza de especies entre regiones. Tarragona presenta valores entre 15 y 55 especies por playa (mediana: 30 especies). Barcelona muestra 30-40 especies por playa. Girona presenta la menor riqueza, con valores generalmente inferiores a 35 especies por playa (mediana: 25 especies).