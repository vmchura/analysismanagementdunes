### Análisis CCA con Cobertura del Suelo a 100m

Esta sección presenta los resultados del Análisis de Correspondencias Canónicas (CCA) usando variables de cobertura del suelo medidas a **100m de distancia** de los sitios de dunas costeras.
