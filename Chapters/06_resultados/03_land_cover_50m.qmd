...
## Cobertura del Suelo en 50m de las Playas

Análisis de la composición de cobertura del suelo a 50m alrededor de cada playa.

```{r}
#| label: fig-cobertura-suelo-50m
#| fig-cap: "Distribución de tipos de cobertura del suelo dentro de 50m de las playas en las tres regiones costeras, mostrando el contexto ambiental de la vegetación dunar"
#| echo: false
#| eval: true
#| output: true
#| fig-pos: "H"
# Graficar composición de cobertura del suelo a 50m por región
ggplot(avg_land_cover %>% filter(distance == "50m"),
       aes(x = region, y = mean_percentage, fill = cover_type_spanish)) +
  geom_bar(stat = "identity", position = "stack") +
  theme_minimal() +
  labs(
    title = "Composición de Cobertura del Suelo\ndentro de 50m de las Playas",
    x = "Región",
    y = "Porcentaje (%)",
...
La @fig-cobertura-suelo-50m muestra la composición por región. Tarragona: urbano (45%), matorral (25%). Barcelona: urbano (60%), pastizal (20%). Girona: urbano (40%), matorral (25%).
