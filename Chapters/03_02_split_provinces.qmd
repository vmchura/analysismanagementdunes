...
## Load global configuration for consistent colors and ordering
...
## Set the specific order of regions using the global configuration
region_counts <- order_provinces(region_counts)

## Create the plot with consistent colors from global configuration
ggplot(region_counts, aes(x = Region, y = Observations, fill = Region)) +
  ...
  # Use the consistent color palette from global_config.R
