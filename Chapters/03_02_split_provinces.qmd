...
División del conjunto de datos por zonas biogeográficas (Girona, Barcelona y Tarragona) basándose en rangos de identificadores de playa para análisis regionales comparativos.
...
Los conjuntos de datos regionales resultantes se guardan para análisis posteriores de variaciones regionales en vegetación dunar y gestión.
